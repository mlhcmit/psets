...
(IMPORTANT) If you are submitting a pdf version of your notebook, we ask you to please **remove cells and outputs (e.g. boilerplate/provided codes, instructions, model training logs, and etc.) that are not directly relevant to the write-up questions.**
