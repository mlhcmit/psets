...
Please follow the following steps to get your Google account connected with MIMIC:
 ...
 - Allow ~30 mins before your account is added to the access group, and check whether you can run the steps in the following [Colab notebook](https://colab.research.google.com/drive/1xReyOAF-dBivEHKJk88HPd9GMZaftxm8?usp=sharing). You may need to make a copy of it to run it.
